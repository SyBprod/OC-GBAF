    ...
    <body>
        ...
        <main>  
            ...
            <section class="no-password">
                ...
                <p class="echo-erreur pb-20"><?php if(isset($_SESSION['erreur'])) echo $_SESSION['erreur']; unset($_SESSION['erreur']); ?></p>
                <p class="echo-info pb-20"><?php if(isset($_GET['info'])) echo $_GET['info']; unset($_GET['info']); ?></p>
                <p class="pb-20">Votre mot de passe est :</p><br />
                <p class="echo-info pb-20"><?php if(isset($_SESSION['pass'])) echo htmlspecialchars($_SESSION['pass']); unset($_SESSION['pass']); ?></p>
